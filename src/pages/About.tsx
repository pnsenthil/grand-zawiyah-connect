          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-lg text-muted-foreground">
                  Through your generous support, we're making a meaningful difference in communities worldwide, 
                  providing education, wellness, and crisis support where it's needed most.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <Card className="border-primary/30 text-center">
                  <CardContent className="p-4">
                    <div className="w-10 h-10 border border-primary/30 rounded-lg flex items-center justify-center mx-auto mb-3">
                      <EducationIcon className="h-5 w-5 text-primary" />
                    </div>
                    <h3 className="font-semibold text-foreground mb-1">Education for All</h3>
                    <p className="text-muted-foreground text-sm">Supporting learning opportunities</p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-primary/30 text-center">
                  <CardContent className="p-4">
                    ...
                    <h3 className="font-semibold text-foreground mb-1">Community Wellness</h3>
                    <p className="text-muted-foreground text-sm">Building healthier communities</p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-primary/30 text-center">
                  <CardContent className="p-4">
                    <div className="w-10 h-10 border border-primary/30 rounded-lg flex items-center justify-center mx-auto mb-3">
                      <CrisisIcon className="h-5 w-5 text-primary" />
                    </div>
                    <h3 className="font-semibold text-foreground mb-1">Crisis Support</h3>
                    <p className="text-muted-foreground text-sm">Emergency relief and aid</p>
                  </CardContent>
                </Card>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <img
                  src="/donation.png"
                  alt="People making donations and contributing to charity"
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-white font-semibold text-sm">Support Our Mission</p>
                        <p className="text-white/80 text-xs">Your sadaqah impacts lives</p>
                      </div>
                    </div>
                  </div>
                </div>
